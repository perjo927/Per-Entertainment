...
var _game = __webpack_require__(116);

__webpack_require__(298);

function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }

var game = new _game.Game("http://localhost:3000/", 1, document);
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        page = document.querySelector.bind(document);
                        _context.next = 3;
...
var Game = exports.Game = function () {
    function Game(host, id, document) {
    ...
    _createClass(Game, [{
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return fetch(this._host + 'game/' + this._id, this._fetchOptions);
        ...
        value: function () {
                ...
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                _context3.next = 2;
                                return fetch(this._host + 'game/1/newround', this._fetchOptions);
            ...
            function _getNewGameRound() {
                return _ref3.apply(this, arguments);
            }

            return _getNewGameRound;
        }()
    }, {
        key: '_getImgBlob',
        value: function () {
            var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(resource) {
                var response;
                return regeneratorRuntime.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                _context4.next = 2;
                                return fetch('' + this._host + resource, this._fetchOptions);
        ...
        key: 'setSymbols',
        value: function () {
            var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(resources, container) {
                var objectURLs, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, resource, imgBlob;
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                _context5.prev = 4;
                                _iterator = resources.symbols[Symbol.iterator]();
                            ...
                            case 6:
                                ...
                                _context5.next = 10;
                                return this._getImgBlob(resource);

                            case 10:
                                imgBlob = _context5.sent;
        ...
        key: '_showAlert',
        value: function () {
            var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(container, message) {
        ...
        value: function () {
            var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(event) {
                var gameRoundData, bonus, outcome, winType, freespinElement, winElement;
                return regeneratorRuntime.wrap(function _callee7$(_context7) {
                    while (1) {
                        switch (_context7.prev = _context7.next) {
                            case 0:
                                _context7.next = 2;
                                return this._getNewGameRound();

                            case 2:
                                gameRoundData = _context7.sent;
                                bonus = gameRoundData.bonus, outcome = gameRoundData.outcome, winType = gameRoundData.winType;
                                freespinElement = this._document.querySelector('.free-spin');
                                winElement = this._document.querySelector('.win');
            ...
            function _handlePlayClick(_x7) {
                return _ref7.apply(this, arguments);
            }

            return _handlePlayClick;
        }()
    }, {
        key: '_clearGrid',
        value: function _clearGrid(container) {
        ...
        key: 'showResult',
        value: function () {
            var _ref8 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(container, outcome) {
                ...
                var url, img, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, _ref9, _ref10, index, symbol;
                    ...
                    while (1) {
                        switch (_context8.prev = _context8.next) {
                            case 0:
                                ...
                                _context8.prev = 5;
                                _iterator3 = outcome.entries()[Symbol.iterator]();
        ...
        key: 'setPlayButton',
        value: function () {
            var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(resources, button) {
                var imgBlob, img;
                    ...
                    while (1) {
                        switch (_context9.prev = _context9.next) {
                            case 0:
                                ...
                                _context9.next = 3;
                                return this._getImgBlob(resources.button);

                            case 3:
                                imgBlob = _context9.sent;
                                img = this._document.createElement("img");
            ...
            function setPlayButton(_x12, _x13) {
                return _ref11.apply(this, arguments);
            }

            return setPlayButton;
        }()
    }, {
        key: 'setTitle',
        value: function setTitle(resources, element) {
